...
<body>
	...
	<div class="w3-bar w3-teal w3-card w3-large">
  		<a href="index.php" class="w3-bar-item 3-button w3-red w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Vehicle Rental System</a>
  ...
  <div class="w3-container w3-center w3-light-grey " style="padding:40px 0px">
	...
	<div class="w3-row-padding w3-padding-64 w3-container">
 	 <div class="w3-content">
          ...
          <button class="3-button w3-black w3-section" type="submit" name="submit">SUBMIT</button>
          <?php 
...
<footer class="w3-container w3-teal w3-card w3-margin-top">  
 ...
 <p class="w3-center">RV Pavan |  1MJ17CS112</p>
</footer>
